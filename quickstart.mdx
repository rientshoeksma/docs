...
Get your AI sommelier up and running as fast as possible.

### Step 1: Add your wines to the inventory

<AccordionGroup>
  <Accordion title="Add your wines individually" icon="copy">
  ...
  <Accordion title="Upload your wine list as a pdf" icon="rectangle-terminal">
...
### Step 2: Create a digital wine menu
