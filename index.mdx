---
title: "Introduction"
description: "Get started with Hopa Hopa your AI sommelier "
---
...
<Columns cols={2}>
  <Card title="Add your own tone of voice" icon="pen-to-square" href="/development">
    Edit your docs locally and preview them in real time.
  </Card>
  <Card title="Add custom wine knowledge" icon="palette" href="/essentials/settings">
